...
<body
            ...
            <div class="breadcrumbs">
                <div class="breadcrumb">
                    <nav class="woocommerce-breadcrumb" aria-label="Breadcrumb">
                        <a href="{{ route('Home') }}">Home</a>&nbsp;&#047;&nbsp;<span>Payment
                            Process</span>
                    </nav>
                </div>
            </div>
    ...
    <div class="payment-options">
        <h2 class="payment-heading">Choose Your Payment Method</h2>
        <div class="payment-buttons">
            <a href="javascript:void(0);" class="online-payment" id="online-payment-btn">
                <i class="fas fa-credit-card" id="online-payment-icon"></i> Online Payment
            </a>
        </div>
    </div>
    <br>
    ...
    <form action="" method="POST">
        <script src="https://checkout.razorpay.com/v1/checkout.js"
            ...
            data-image="https://www.pngall.com/wp-content/uploads/12/Modern-Garage-PNG-Picture.png"
            data-notes.customer_name="Niraj"
            data-notes.customer_email="njthesiya@gmail.com"
            data-notes.product_name="Oil"
            data-notes.quantity="1"
            data-prefill.name="Niraj">
        </script>
    </form>

    <script>
        const RAZORPAY_KEY = "rzp_test_L7j9TwMhjz0QWO";
        ...
        const RAZORPAY_OPTIONS = {
            ...
            image: "https://www.pngall.com/wp-content/uploads/12/Modern-Garage-PNG-Picture.png",
            prefill: {
                name: "Niraj",
                email: "njthesiya@gmail.com",
                contact: "7817859959",
            },
            notes: {
                customer_name: "Niraj",
                customer_email: "njthesiya@gmail.com",
                product_name: "Oil",
                quantity: "1",
            },
            theme: {
        ...
        document.getElementById("online-payment-btn").addEventListener("click", function(event) {
            event.preventDefault();
            const icon = document.getElementById("online-payment-icon");
            icon.classList.add("fa-spinner", "loading");
            icon.classList.remove("fa-credit-card");

            setTimeout(() => {
                icon.classList.remove("fa-spinner", "loading");
