...
<style>
    ...
    .nav-aside_text:hover {
        background: linear-gradient(90deg, #ffffff 0%, #ffffff 100%);
        cursor: pointer;
    }

    .nav-aside_text:hover::after {
        transform: scaleX(1);
    }
...
<body
    class="car_services-template-default single single-car_services postid-2266 wp-embed-responsive layout-1 theme-car-repair-services woocommerce-no-js elementor-default elementor-kit-2482 elementor-page elementor-page-2266">
            ...
            <div class="container">
                <div class="row service-single">
                    <div class="col-12 col-sm-5 col-md-4">
                        <div class="block-aside-wrapper">
                            {{-- <div class="block-aside__wrapper widget block-aside" id="service_menu-2">
                                <h4 class="block-aside__title">Service Menu</h4>
                                        ...
                                        <ul>
                                            @if (isset($services))
                                                @foreach ($services as $service)
                                                    <li>
                                                        <a href="{{ route('services_type.show', $service->service_id) }}"
                                                            title="{{ $service->service_name }}">
                                                            <span
                                                                class="nav-aside_text">{{ $service->service_name }}</span>
                                                        </a>
                                                    </li>
                                                @endforeach
                                            @else
                            ...
                            <div class="block-aside__wrapper widget block-aside" id="smart_contact_list-2">
                                <h4 class="block-aside__title">Contacts</h4>
                    ...
                    <div class="col-12 col-sm-7 col-md-8">
                        {{-- <img src="{{ asset($service->service_image) }}" class="img-responsive"
                            alt="{{ $service->service_name }}" style="width: 770px; height: 355px;" /> --}}
                        <div class="divider-lg"></div>

                        <h1>{{ $service->service_name }}</h1>
                        <h6
                            style="font-family: 'Poppins', sans-serif; font-size: 1.5rem; color: #000; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 15px; border-left: 6px solid #000; padding-left: 15px; background: linear-gradient(to right, #f0f0f0, #ffffff); box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.1); border-radius: 4px; display: inline-block;">
                            {{ $service->service_topic }}
                        </h6><br>
                        <hr style="border: 1.5px solid #000; background-color: #000;">
                        <div data-elementor-type="wp-post" data-elementor-id="2266" class="elementor elementor-2266">
                            <section
                                class="elementor-section elementor-top-section elementor-element elementor-element-7ffe8b6b elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                data-id="7ffe8b6b" data-element_type="section">
                                <div class="elementor-container elementor-column-gap-no">
                                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-31ccb75a"
                                        data-id="31ccb75a" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-5288f7bb elementor-widget elementor-widget-text-editor"
                                                data-id="5288f7bb" data-element_type="widget"
                                                data-widget_type="text-editor.default">
                                                <div class="elementor-widget-container">
                                                    <p>{!! nl2br(e($service->service_description)) !!}</p>
                                                </div>
                                            </div>
                                            <div class="service-box">
                                                ...
                                                <div class="service-content">
                                                    ...
                                                    {{-- <p class="service-description">{!! nl2br(e($service->service_description)) !!}</p> --}}
                            ...
                            <section
                                class="elementor-section elementor-top-section elementor-element elementor-element-45ac594e elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                data-id="45ac594e" data-element_type="section">
                                <div class="elementor-container elementor-column-gap-no">
                                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-393e3a3e"
                                        data-id="393e3a3e" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-247ed5c1 elementor-widget elementor-widget-text-editor"
                                                data-id="247ed5c1" data-element_type="widget"
                                                data-widget_type="text-editor.default">
                                                <div class="elementor-widget-container">
                                                    <p>While you’re there, let us perform a Touch® Courtesy Check, which
                                                        includes a visual check of the following items:</p>
                                                    ...
                                                    <p> Oil change near me? The next time you ask this question, just
                                                        look for your neighborhood Car Repair Service. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <section
                                class="elementor-section elementor-top-section elementor-element elementor-element-5589c62b content-top elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                data-id="5589c62b" data-element_type="section">
                                <div class="elementor-container elementor-column-gap-default">
                                    <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-ef14add"
                                        data-id="ef14add" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-1444c5a3 elementor-widget elementor-widget-image"
                                                data-id="1444c5a3" data-element_type="widget"
                                                data-widget_type="image.default">
                                                <div class="elementor-widget-container">
                                                    <img fetchpriority="high" fetchpriority="high" decoding="async"
                                                        width="350" height="348"
                                                        src="../../wp-content/uploads/sites/5/2017/03/services-item-img02-1.jpg"
                                                        class="attachment-full size-full wp-image-2127" alt=""
                                                        srcset="https://smartdata.tonytemplates.com/car-repair-service-v4/car1/wp-content/uploads/sites/5/2017/03/services-item-img02-1.jpg 350w, https://smartdata.tonytemplates.com/car-repair-service-v4/car1/wp-content/uploads/sites/5/2017/03/services-item-img02-1-300x298.jpg 300w, https://smartdata.tonytemplates.com/car-repair-service-v4/car1/wp-content/uploads/sites/5/2017/03/services-item-img02-1-150x150.jpg 150w, https://smartdata.tonytemplates.com/car-repair-service-v4/car1/wp-content/uploads/sites/5/2017/03/services-item-img02-1-63x63.jpg 63w, https://smartdata.tonytemplates.com/car-repair-service-v4/car1/wp-content/uploads/sites/5/2017/03/services-item-img02-1-100x100.jpg 100w"
                                                        sizes="(max-width: 350px) 100vw, 350px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-1dec1a58"
                                        data-id="1dec1a58" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-30f8a4f2 elementor-widget elementor-widget-text-editor"
                                                data-id="30f8a4f2" data-element_type="widget"
                                                data-widget_type="text-editor.default">
                                                <div class="elementor-widget-container">
                                                    <div class="divider-lg hidden-lg"></div>
                                                    <h3>Trust Our Products</h3>
                                                    <p>For over 60 years, Car Repair Service has been helping drivers
                                                        across North America maintain their vehicles. With ASE-certified
                                                        mechanics in all of our stores, we can take care of all of your
                                                        auto repair and maintenance needs.</p>

                                                    <p>From oil changes, filter replacements, and fluid flushes to
                                                        brakes and brake repair, shocks and struts, muffler repair,
                                                        tires, and wheel alignment, we’ve got you covered. Use the quick
                                                        links in the gold bar to book an appointment at your Car Repair
                                                        Service store today!</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <section
                                class="elementor-section elementor-top-section elementor-element elementor-element-6d5d060 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                data-id="6d5d060" data-element_type="section">
                                <div class="elementor-container elementor-column-gap-default">
                                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-1a79ef87"
                                        data-id="1a79ef87" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-47659f8f elementor-widget elementor-widget-text-editor"
                                                data-id="47659f8f" data-element_type="widget"
                                                data-widget_type="text-editor.default">
                                                <div class="elementor-widget-container">
                                                    <p class="content-top-lg"> Oil is the lifeblood of your engine. It
                                                        reduces friction, lessens wear, provides lubrication, forms a
                                                        seal between the pistons, rings and cylinder walls while helping
                                                        to cool engine parts. Without the cleaning action of new oil,
                                                        carbon and varnish buildup would be toxic to the engine. And
                                                        engine oil even dampens the shock and noise of moving parts.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
